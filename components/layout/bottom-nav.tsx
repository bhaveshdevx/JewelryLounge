            ...
            {NAV_TABS.map((tab) => {
                ...
                return (
                    <Link
                        key={tab.href}
                        href={tab.href}
                        className={`flex flex-col items-center justify-center gap-0.5 w-14 transition-colors ${isActive
                                ? "text-primary"
                    ...
                    >
                        <span className="relative">
                            ...
                            {tab.label === "Cart" && totalItems > 0 && (
                                <span className="absolute -top-1 -right-2 bg-primary text-white text-[8px] font-bold h-3.5 min-w-[14px] flex items-center justify-center rounded-full border border-white px-0.5">
